...
def addBypassRefinementModule(high, low, num_filters, weight_decay, name='bypass', dropout_rate=0.2):
    ...
    return BatchNormalization()(Dropout(dropout_rate)(postConv))
...
def get_residual_model_with_batch_norm(input_shape, num_classes, residual_encoder_connections=False, dropout_rate=0.2, weight_decay=0.0002):
    i = Input(input_shape)
    convI = BatchNormalization()(Conv2D(64, (3,3), padding='same', activation='elu', name='conv1', kernel_regularizer=l2(weight_decay))(i))
