...
def getModel(input_shape, num_classes, dropout_rate=0.2, weight_decay=0.0002):
    i = Input(input_shape)
    ...
    prediction = Conv2D(num_classes, (1,1), padding='same', activation='softmax', name='main', kernel_regularizer=l2(weight_decay))(BatchNormalization()(trans_conv15))
